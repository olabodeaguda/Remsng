...
namespace RemsNG.Common.Utilities
{
    ...
    {
        public static List<string> StatusLst => Enum.GetNames(typeof(UserStatus)).Cast<string>().ToList();

        public static List<string> DemandNoticeStatusLst => Enum.GetNames(typeof(DemandNoticeStatus)).Cast<string>().ToList();
        ...
        public static string GetBatchNo()
        {
            ...
            {
                bool ct = int.TryParse(tm.ToString(), out int newct);
                if (!ct)
                {
                    continue;
                }
