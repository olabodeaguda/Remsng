...
let CategoryComponent = class CategoryComponent {
    constructor(categoryService, activeRoute, lcdaService, toasterService) {
    ...
    getLcda(lcdaId) {
        ...
        this.lcdaService.getLCdaById(lcdaId).subscribe(response => {
            this.isLoading = false;
            const objSchema = Object.assign(new __WEBPACK_IMPORTED_MODULE_5__shared_models_response_model__["a" /* ResponseModel */](), response);
    ...
    actions() {
        ...
        if (this.categoryModel.eventType === 'ADD') {
            ...
            this.categoryService.add(this.categoryModel).subscribe(response => {
                ...
                const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_5__shared_models_response_model__["a" /* ResponseModel */](), response);
                if (result.code === '00') {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('removeModal'),
...
CategoryComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__services_category_service__["a" /* CategoryService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_category_service__["a" /* CategoryService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__lcda_services_lcda_services__["a" /* LcdaService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__lcda_services_lcda_services__["a" /* LcdaService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6_angular2_toaster_angular2_toaster__["b" /* ToasterService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_angular2_toaster_angular2_toaster__["b" /* ToasterService */]) === "function" && _f || Object])
], CategoryComponent);
...
DashBoardModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__shared_shared_module__["a" /* SharedModule */], __WEBPACK_IMPORTED_MODULE_6_angular4_carousel__["a" /* CarouselModule */],
...
let AddressGlobalModule = class AddressGlobalModule {
};
...
let AddressGlobalComponent = class AddressGlobalComponent {
    constructor(streetservice, addressService, toasterService, activeRoute, lcdaService) {
    ...
    getLcda() {
        ...
        this.lcdaService.getLCdaById(this.lcdaId).subscribe(response => {
            const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_3__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (result.code == '00') {
                this.lgda = Object.assign(new __WEBPACK_IMPORTED_MODULE_8__lcda_models_lcda_models__["a" /* LcdaModel */](), result.data);
            }
        }, error => {
        });
    }
    getStreet() {
        ...
        this.isLoading = true;
        this.streetservice.bylcda(this.lcdaId).subscribe(response => {
            this.isLoading = false;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('removeAddressModal'),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _b || Object)
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AddressGlobalModel;
...
let AddressGlobalService = class AddressGlobalService {
    constructor(dataservice) {
        this.dataservice = dataservice;
    }
    byOwnerId(ownderId, lcdaId) {
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_13__domain_domain_module__["a" /* DomainModule */], __WEBPACK_IMPORTED_MODULE_27__angular_common_http__["a" /* HttpClientModule */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_9_angular2_toaster__["b" /* ToasterService */], __WEBPACK_IMPORTED_MODULE_10__shared_models_app_settings__["a" /* AppSettings */], __WEBPACK_IMPORTED_MODULE_11__shared_services_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_12__shared_services_storage_service__["a" /* StorageService */], {
                provide: __WEBPACK_IMPORTED_MODULE_27__angular_common_http__["b" /* HTTP_INTERCEPTORS */],
...
let CompanyProfileComponent = class CompanyProfileComponent {
    constructor(activeRoute, companyservice, toasterService, lcdaservice) {
        this.activeRoute = activeRoute;
    ...
    getCompany(coyId) {
        this.companyservice.ById(coyId).subscribe(response => {
            this.companyModel = Object.assign(new __WEBPACK_IMPORTED_MODULE_1__models_company_model__["a" /* CompanyModel */](), response);
            this.getLcda();
        }, error => {
            this.toasterService.pop('error', 'Error', error);
        });
    ...
    getLcda() {
        ...
        this.lcdaservice.getLCdaById(this.companyModel.lcdaId).subscribe(response => {
            this.isLoading = false;
            const objSchema = Object.assign(new __WEBPACK_IMPORTED_MODULE_6__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (objSchema.code == '00') {
                this.lcdaModel = objSchema.data;
            }
            else {
...
let CompanyComponent = class CompanyComponent {
    constructor(activeRoute, lcdaservice, sectorService, categoryservice, companyservice, toasterService) {
        this.activeRoute = activeRoute;
        this.lcdaservice = lcdaservice;
    ...
    getLcda(lcdaId) {
        ...
        this.lcdaservice.getLCdaById(lcdaId).subscribe(response => {
            this.isLoading = false;
            const objSchema = Object.assign(new __WEBPACK_IMPORTED_MODULE_7__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (objSchema.code == '00') {
                this.lcdaModel = objSchema.data;
    ...
    actions() {
        ...
        if (this.companyModel.eventType === 'ADD') {
            this.companyservice.add(this.companyModel).subscribe(response => {
                ...
                const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_7__shared_models_response_model__["a" /* ResponseModel */](), response);
                if (result.code === '00') {
                    jQuery(this.addModal.nativeElement).modal('hide');
                    this.getCompanyByLcda();
                }
...
let CoyMiniProfileComponent = class CoyMiniProfileComponent {
    constructor(sectorService, categoryservice, toasterService, companyservice) {
        this.sectorService = sectorService;
        this.categoryservice = categoryservice;
        this.toasterService = toasterService;
        this.companyservice = companyservice;
    ...
    actions() {
        ...
        if (this.companyModel.eventType === 'EDIT' || this.companyModel.eventType === 'CANCEL') {
            this.companyservice.update(this.companyModel).subscribe(response => {
                this.companyModel.isLoading = false;
                const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_6__shared_models_response_model__["a" /* ResponseModel */](), response);
                if (result.code === '00') {
                    this.toasterService.pop('success', 'Success', result.description);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = CompanyModel;
...
let CompanyItemModule = class CompanyItemModule {
};
...
let ComponentItemComponent = class ComponentItemComponent {
    constructor(companyitemservice, activeRoute, toasterService, companyservice, itemservice, appsettings) {
    ...
    actions() {
        ...
        if (this.companyItem.eventType === 'ADD') {
            this.companyitemservice.add(this.companyItem).subscribe(response => {
                ...
                const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_10__shared_models_response_model__["a" /* ResponseModel */](), response);
                if (result.code == '00') {
                    this.getItemByTaxpayerId();
                    this.getCompanyitemsByTaxPayers();
                    jQuery(this.addModal.nativeElement).modal('hide');
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('changeModal'),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _b || Object)
...
/* harmony export (immutable) */ __webpack_exports__["a"] = CompanyItem;
...
let ComponentItemService = class ComponentItemService {
    constructor(dataservice) {
        this.dataservice = dataservice;
    }
    getCompanyItemByTaxpayer(taxpayerId, pageModel) {
        this.dataservice.addToHeader('pageNum', pageModel.pageNum.toString());
        this.dataservice.addToHeader('pageSize', pageModel.pageSize.toString());
...
let DemandNoticeIndexComponent = class DemandNoticeIndexComponent {
};
...
let DemandNoticeSearchComponent = class DemandNoticeSearchComponent {
    constructor(appsettings, toasterService, dnTaxpayer, bankService, dnPaymentService) {
        this.appsettings = appsettings;
        this.toasterService = toasterService;
    ...
    downloadReciept(id, billingNumber) {
    ...
    getAmountDueByBillingNo(billingNo) {
        this.isLoading = true;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('paymentModal'),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _b || Object)
], DemandNoticeSearchComponent.prototype, "paymentModal", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('paymentListModal'),
...
DemandNoticeSearchComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__shared_models_app_settings__["a" /* AppSettings */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__shared_models_app_settings__["a" /* AppSettings */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4_angular2_toaster__["b" /* ToasterService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_angular2_toaster__["b" /* ToasterService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5__services_demand_noticeTaxpayer_service__["a" /* DemandNoticeTaxpayerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_demand_noticeTaxpayer_service__["a" /* DemandNoticeTaxpayerService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_9__shared_services_bank_service__["a" /* BankService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__shared_services_bank_service__["a" /* BankService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_10__services_demand_notice_payment_service__["a" /* DemandNoticePaymentService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_10__services_demand_notice_payment_service__["a" /* DemandNoticePaymentService */]) === "function" && _h || Object])
...
let DemandNoticeComponent = class DemandNoticeComponent {
    constructor(appsettings, demandnoticeservice, toasterService, wardservice, streetservice, dtsService) {
        this.appsettings = appsettings;
    ...
    submitDemandRequest() {
        ...
        this.demandnoticeservice.add(this.searchModel).subscribe(response => {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('downRequestPrompt'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _a || Object)
], DemandNoticeComponent.prototype, "downRequestPromptModal", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('downloadRequestModal'),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _b || Object)
...
let DemandNoticeTaxpayersComponent = class DemandNoticeTaxpayersComponent {
    constructor(activeRoute, dtsService, dNotice, sanitizer, appsettings, toasterService, storageService) {
        this.activeRoute = activeRoute;
        this.dtsService = dtsService;
    ...
    getDemandNoticeByBatchId(batchno) {
...
let DemandNoticeModule = class DemandNoticeModule {
};
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AmountDueModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DemandNoticeModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DemandNoticeSearch;
...
"use strict";
class DemandNoticePaymentModel {
    constructor() {
        this.ownerId = '';
        this.billingNumber = '';
        this.amount = 0;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DemandNoticePaymentModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DownloadRequestModel;
...
let DemandNoticePaymentService = class DemandNoticePaymentService {
    constructor(dataservice) {
        this.dataservice = dataservice;
    }
    registerPayment(dnpModel) {
...
let DemandNoticeService = class DemandNoticeService {
    constructor(datataservice) {
...
let DemandNoticeTaxpayerService = class DemandNoticeTaxpayerService {
    constructor(dataservice) {
        this.dataservice = dataservice;
    }
    byBatchId(batchId, pageModel) {
        this.dataservice.addToHeader('pageNum', pageModel.pageNum.toString());
        this.dataservice.addToHeader('pageSize', pageModel.pageSize.toString());
        return this.dataservice.get('dnt/batchno/' + batchId)
            .catch(error => this.dataservice.handleError(error));
    }
    ByBillingno(billingnumber) {
    ...
    amountDueByBillingNo(billingnumber) {
        return this.dataservice.get('amountdue/' + billingnumber)
            .catch(error => this.dataservice.handleError(error));
    }
    UpdateAmount(amountDueModel) {
...
let DomainComponent = class DomainComponent {
    constructor(domainService, appSettings, stateSrv) {
    ...
    getStates() {
        this.stateSrv.GetStates().subscribe(response => {
    ...
    addDomain() {
        ...
        if (this.domainModel.eventType === this.appSettings.addMode) {
            this.domainService.add(this.domainModel).subscribe(response => {
                ...
                const resp = Object.assign(new __WEBPACK_IMPORTED_MODULE_5__shared_models_response_model__["a" /* ResponseModel */](), response);
                if (resp.code === '00') {
                    this.domainModel = new __WEBPACK_IMPORTED_MODULE_1__models_domain_model__["a" /* DomainModel */]();
                    jQuery(this.addModal.nativeElement).modal('hide');
                    this.getDomain();
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DomainModel;
...
let DomainService = class DomainService {
    ...
    all(pageModel) {
        this.dataService.addToHeader('pageSize', pageModel.pageSize.toString());
        this.dataService.addToHeader('pageNum', pageModel.pageNum.toString());
        return this.dataService.get('domain/all').catch(error => this.dataService.handleError(error));
    }
    CurrentDomain() {
        return this.dataService.get('domain/currentdomain').catch(error => this.dataService.handleError(error));
    }
    activeDomains() {
        return this.dataService.get('domain/activeDomain').catch(error => this.dataService.handleError(error));
    }
    add(domainModel) {
...
let ItemPenaltyComponent = class ItemPenaltyComponent {
    constructor(activeRoute, itemService, toasterService, itempservice) {
        this.activeRoute = activeRoute;
        this.itemService = itemService;
        this.toasterService = toasterService;
    ...
    getItem(itemId) {
        ...
        this.itemService.byId(itemId).subscribe(response => {
            this.isLoading = false;
            const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_3__items_models_item_model__["a" /* ItemModel */](), response);
            this.item = result;
    ...
    actions() {
        ...
        if (this.itempModel.eventType === 'ADD') {
            this.itempservice.add(this.itempModel).subscribe(response => {
                ...
                const resp = Object.assign(new __WEBPACK_IMPORTED_MODULE_6__shared_models_response_model__["a" /* ResponseModel */](), response);
                if (resp.code) {
...
let ItemPenaltyModule = class ItemPenaltyModule {
};
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ItemPenaltyModel;
...
let ItemPenaltyService = class ItemPenaltyService {
    constructor(dataservice) {
        this.dataservice = dataservice;
    }
    getByitemId(itemId) {
    ...
    getByitemIdPaginated(itemId, pageModel) {
        this.dataservice.addToHeader('pageNum', pageModel.pageNum.toString());
        this.dataservice.addToHeader('pageSize', pageModel.pageSize.toString());
...
let ItemComponent = class ItemComponent {
    constructor(activeRoute, toasterService, lcdaService, itemService) {
        this.activeRoute = activeRoute;
        this.toasterService = toasterService;
        this.lcdaService = lcdaService;
        this.itemService = itemService;
    ...
    getLcda(lcdaId) {
        ...
        this.lcdaService.getLCdaById(lcdaId).subscribe(response => {
            this.isLoading = false;
            const objSchema = Object.assign(new __WEBPACK_IMPORTED_MODULE_3__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (objSchema.code == '00') {
                this.lcdaModel = objSchema.data;
                this.getItems();
            }
...
let ItemService = class ItemService {
    ...
    getByLcdaId(lcdaId, pageModel) {
        this.dataservice.addToHeader('pageSize', pageModel.pageSize.toString());
        this.dataservice.addToHeader('pageNum', pageModel.pageNum.toString());
        return this.dataservice.get('item/bylcdapaginated/' + lcdaId).catch(x => this.dataservice.handleError(x));
    }
    byId(id) {
        return this.dataservice.get('item/' + id).catch(x => this.dataservice.handleError(x));
    }
    add(itemmodel) {
...
let LcdaComponent = class LcdaComponent {
    constructor(lcdaService, appSettings, toasterService, domainService) {
        this.lcdaService = lcdaService;
        this.appSettings = appSettings;
        this.toasterService = toasterService;
        this.domainService = domainService;
...
let LCDAModule = class LCDAModule {
};
LCDAModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4_angular2_ladda__["LaddaModule"],
            __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_8__items_item_module__["a" /* ItemModule */], __WEBPACK_IMPORTED_MODULE_10__Category_category_module__["a" /* CategoryModule */],
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LcdaModel;
...
let LcdaService = class LcdaService {
    constructor(dataService) {
        this.dataService = dataService;
    }
    all() {
        return this.dataService.get('lcda/total').catch(error => this.dataService.handleError(error));
    }
    getLcda(pageModel) {
        this.dataService.addToHeader('pageSize', pageModel.pageSize.toString());
        this.dataService.addToHeader('pageNum', pageModel.pageNum.toString());
        return this.dataService.get('lcda/all').catch(error => this.dataService.handleError(error));
    }
    addLCDA(lcdaModel) {
...
let LoginComponent = class LoginComponent {
    constructor(router, loginService, storageService, appsettings) {
        this.router = router;
    ...
    signIn() {
        ...
        this.loginService.SignIn(this.loginModel).subscribe(response => {
            ...
            const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_4__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (result.code === '00') {
                const usermodel = Object.assign(new __WEBPACK_IMPORTED_MODULE_6__shared_models_user_model__["a" /* UserModel */](), result.data);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LoginModel;
...
let MediaFileComponent = class MediaFileComponent {
    constructor(toasterService, activeRoute, lcdaService, mediaService, sanitizer, appsettings) {
        this.toasterService = toasterService;
        this.activeRoute = activeRoute;
        this.lcdaService = lcdaService;
    ...
    getLcda() {
        ...
        this.lcdaService.getLCdaById(this.lcdaId).subscribe(response => {
            ...
            const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_5__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (result.code == '00') {
                this.lgda = Object.assign(new __WEBPACK_IMPORTED_MODULE_4__lcda_models_lcda_models__["a" /* LcdaModel */](), result.data);
...
let MediaFilesModule = class MediaFilesModule {
};
...
/* harmony export (immutable) */ __webpack_exports__["a"] = MediaFileModel;
...
let PermissionComponent = class PermissionComponent {
    constructor(activeRoute, permissionService, roleService, appSettings, toasterService) {
        this.activeRoute = activeRoute;
    ...
    getRole(id) {
        ...
        this.roleService.get(id).subscribe(response => {
            this.isLoading = false;
            this.roleModel = Object.assign(new __WEBPACK_IMPORTED_MODULE_4__models_role_model__["a" /* RoleModel */](), response);
    ...
    notifyUI(response) {
        const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_9__shared_models_response_model__["a" /* ResponseModel */](), response);
        if (result.code === "00") {
            this.toasterService.pop('success', 'Success', result.description);
            this.getPermissionByRoleId();
            this.getPermissionNotInRole();
...
let RoleProfileComponent = class RoleProfileComponent {
    constructor(toasterService, lcdaservice, roleservice, appSettings) {
        this.toasterService = toasterService;
        this.lcdaservice = lcdaservice;
        this.roleservice = roleservice;
        this.appSettings = appSettings;
    ...
    getCurrentUserDomain() {
        this.lcdaservice.getLcdaByuserId(this.profileModel.id).subscribe(response => {
            const resp = Object.assign(new __WEBPACK_IMPORTED_MODULE_4__shared_models_response_model__["a" /* ResponseModel */](), response);
    ...
    roleAction(eventType) {
        ...
        if (eventType === 'REMOVE_ROLE') {
            ...
            this.lcdaservice.removeUserFromLCDA(this.selectedDomain.id, this.profileModel.id)
                ...
                const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_4__shared_models_response_model__["a" /* ResponseModel */](), responnse);
                if (result.code == '00') {
                    this.getCurrentUserDomain();
                    this.toasterService.pop('success', 'Success', result.description);
    ...
    domainSelectedChange(element, fromType) {
        this.isLoading = true;
        if (fromType === 'ALL_DOMAINROLE') {
            ...
            this.roleservice.roleByDomainIdUserId(element.id, this.profileModel.id).subscribe(response => {
                this.isLoading = false;
                const schema = { code: '', data: new __WEBPACK_IMPORTED_MODULE_3__models_role_model__["a" /* RoleModel */]() };
    ...
    action(eventType) {
        if (eventType === this.appSettings.assignLGDA) {
            ...
            this.roleservice.assignRoleTouser(this.assignRoleModel).subscribe(response => {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('removeRole'),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _b || Object)
], RoleProfileComponent.prototype, "removeRoleModal", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('removeDomain'),
    __metadata("design:type", typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _c || Object)
], RoleProfileComponent.prototype, "removeDomainModal", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('assignlgda'),
    __metadata("design:type", typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _d || Object)
], RoleProfileComponent.prototype, "assignlgdaModal", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('assignrolemodal'),
...
let RoleComponent = class RoleComponent {
    constructor(roleService, appSettings, toasterService, domainservice) {
        this.roleService = roleService;
        this.appSettings = appSettings;
        this.toasterService = toasterService;
        this.domainservice = domainservice;
    ...
    getDomains() {
        ...
        this.domainservice.CurrentDomain().subscribe(response => {
            ...
            const res = Object.assign(new __WEBPACK_IMPORTED_MODULE_7__shared_models_response_model__["a" /* ResponseModel */](), response);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RolePermissionModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = RoleModel;
...
let RoleService = class RoleService {
    ...
    getRoles(pageModel) {
        this.dataService.addToHeader('pageSize', pageModel.pageSize.toString());
        this.dataService.addToHeader('pageNum', pageModel.pageNum.toString());
        return this.dataService.get('role').catch(error => this.dataService.handleError(error));
    }
    add(roleModel) {
    ...
    changeStatus(roleModel) {
        return this.dataService.post('role/changestatus', {
            roleStatus: roleModel.roleStatus,
            id: roleModel.id
        }).catch(error => this.dataService.handleError(error));
    }
    getAllDomainRoles(usrname) {
        this.dataService.addToHeader('username', usrname);
        return this.dataService.get('role/alldomainroles').catch(error => this.dataService.handleError(error));
    }
    assignRoleTouser(assignRoleModel) {
...
let SectorComponent = class SectorComponent {
    constructor(activeRoute, lcdaService, toasterService, sectorService) {
        this.activeRoute = activeRoute;
        this.lcdaService = lcdaService;
        this.toasterService = toasterService;
        this.sectorService = sectorService;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = SectorModel;
...
let AppSettings = class AppSettings {
    ...
    validatePhoneNumber(value) {
        const reg2 = '^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{3,9}$';
    ...
    getYearList() {
        const initalNum = 2017;
        const nm = new Date().getFullYear();
        let s = [];
        for (let i = (nm + 1); i >= initalNum; i--) {
            s.push(i);
        }
        return s;
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = PageModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ResponseModel;
...
let DataService = class DataService {
    constructor(http, router, appConfig, toasterService, storageService) {
        this.http = http;
        this.router = router;
    ...
    addBearer() {
        const tk = this.storageService.get();
    ...
    postWithoutHeader1(url, body, hd) {
        return this.http.post(this.appConfig.BASE_URL + url, body, {
    ...
    handleError(err) {
        const res = Object.assign(new __WEBPACK_IMPORTED_MODULE_5__models_response_model__["a" /* ResponseModel */](), err.error);
        if (err.status === 404) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["Observable"].throw(res.description || 'Internal server error occur. Please contact administrator');
        }
...
let GlobalInterceptorService = class GlobalInterceptorService {
    constructor(storageservice) {
        this.storageservice = storageservice;
    }
    intercept(req, next) {
        return next
            ...
            if (event instanceof __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpResponse */]) {
                if (event.headers.has('new-t')) {
                    const token = event.headers.get('new-t');
...
let StorageService = class StorageService {
    ...
    remove() {
        ...
        const usermodel = new __WEBPACK_IMPORTED_MODULE_0__models_user_model__["a" /* UserModel */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_state_service__ = __webpack_require__("../../../../../src/app/shared/services/state.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_bank_service__ = __webpack_require__("../../../../../src/app/shared/services/bank.service.ts");
...
SharedModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_7_angular2_toaster__["b" /* ToasterService */], __WEBPACK_IMPORTED_MODULE_9__services_state_service__["a" /* StateService */], __WEBPACK_IMPORTED_MODULE_10__services_bank_service__["a" /* BankService */]],
        exports: [
            __WEBPACK_IMPORTED_MODULE_3__components_header_component__["a" /* HeaderComponent */], __WEBPACK_IMPORTED_MODULE_4__components_sideBar_component__["a" /* SideBarComponent */], __WEBPACK_IMPORTED_MODULE_5__components_footer_component__["a" /* FooterComponent */]
        ]
    })
...
let StreetComponent = class StreetComponent {
    constructor(activeRoute, streetservice, wardService, toasterService) {
        this.activeRoute = activeRoute;
        this.streetservice = streetservice;
        this.wardService = wardService;
        this.toasterService = toasterService;
    ...
    getWard(id) {
        ...
        this.wardService.byId(id).subscribe(response => {
            this.isLoading = false;
            this.wardmodel = Object.assign(new __WEBPACK_IMPORTED_MODULE_1__ward_models_ward_model__["a" /* WardModel */](), response);
            this.getStreet();
        }, error => {
            this.toasterService.pop('error', 'Error', error);
        });
    ...
    actions() {
        ...
        if (this.streetModel.eventType === 'ADD') {
            this.streetservice.add(this.streetModel).subscribe(response => {
                ...
                const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_8__shared_models_response_model__["a" /* ResponseModel */](), response);
                if (result.code == '00') {
                    this.getStreet();
                    this.toasterService.pop('success', 'Success', result.description);
                    jQuery(this.addModal.nativeElement).modal('hide');
...
/* harmony export (immutable) */ __webpack_exports__["a"] = StreetModel;
...
let StreetService = class StreetService {
    ...
    byWardIdpaginated(wardid, pageModel) {
...
let StreetModule = class StreetModule {
};
...
let TaxPayerComponent = class TaxPayerComponent {
    constructor(activeRoute, streetservice, taxpayerservice, companyservice, toasterService, itemservice) {
        this.activeRoute = activeRoute;
        this.streetservice = streetservice;
    ...
    getStreet(streetId) {
        ...
        this.streetservice.byId(streetId).subscribe(response => {
            this.isLoading = false;
            this.streetModel = Object.assign(new __WEBPACK_IMPORTED_MODULE_3__street_models_street_model__["a" /* StreetModel */](), response);
        ...
        if (this.taxpayerModel.eventType == 'ADD') {
            this.taxpayerservice.add(this.taxpayerModel).subscribe(response => {
                ...
                if (result.code === '00') {
                    ...
                    const res = confirm(result.description + '. Are you sure');
                    if (res) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = TaxpayerModel;
...
let TaxpayerService = class TaxpayerService {
    constructor(dataservice) {
        this.dataservice = dataservice;
    }
    byLcda(lcdaId, pageModel) {
        this.dataservice.addToHeader('pageNum', pageModel.pageNum.toString());
        this.dataservice.addToHeader('pageSize', pageModel.pageSize.toString());
        return this.dataservice.get('bylcdapaginated/' + lcdaId).catch(x => this.dataservice.handleError(x));
    }
    byStreet(lcdaId, pageModel) {
        this.dataservice.addToHeader('pageNum', pageModel.pageNum.toString());
        this.dataservice.addToHeader('pageSize', pageModel.pageSize.toString());
...
let TaxPayersModule = class TaxPayersModule {
};
TaxPayersModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_6__components_taxpayer_component__["a" /* TaxPayerComponent */]
        ],
...
let AddressComponent = class AddressComponent {
    constructor(streetservice, addressService, toasterService) {
        this.streetservice = streetservice;
        this.addressService = addressService;
        this.toasterService = toasterService;
        this.addresses = [];
    ...
    getStreet() {
        ...
        this.streetservice.bylcda(this.profileModel.lcdaId).subscribe(response => {
            this.streets = Object.assign([], response);
        }, error => {
        });
    }
...
let ContactComponent = class ContactComponent {
    constructor(appSettings, toasterService, userService, contactService) {
        this.appSettings = appSettings;
        this.toasterService = toasterService;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('removeContact'),
    __metadata("design:type", typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _d || Object)
...
let ProfileComponent = class ProfileComponent {
    constructor(userService, toasterService) {
        this.userService = userService;
        this.toasterService = toasterService;
        this.isLoading = false;
        this.isDisabled = true;
    ...
    update() {
        ...
        this.userService.update(this.profileModel).subscribe(response => {
            this.isLoading = false;
            const respD = Object.assign(new __WEBPACK_IMPORTED_MODULE_2__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (respD.code == '00') {
...
let UserProfileComponent = class UserProfileComponent {
    constructor(activeRoute, userService, toasterService) {
        this.activeRoute = activeRoute;
        this.userService = userService;
        this.toasterService = toasterService;
...
let UserComponent = class UserComponent {
    constructor(userService, appSettings, toasterService, lcdaService, roleservice, router) {
        this.userService = userService;
        this.appSettings = appSettings;
        this.toasterService = toasterService;
        this.lcdaService = lcdaService;
    ...
    getCurrentUserRole(id) {
        this.roleservice.getUserRole(id).subscribe(response => {
            const resp = Object.assign(new __WEBPACK_IMPORTED_MODULE_5__shared_models_response_model__["a" /* ResponseModel */](), response.json());
    ...
    getAllDomainRole(username, loadview) {
        this.isLoading = true;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('changepwd'),
    __metadata("design:type", typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _c || Object)
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('assignrole'),
    __metadata("design:type", typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _e || Object)
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AddressModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AssignRoleModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AssignDomainModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ChangePasswordModel;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ProfileModel;
...
let ContactService = class ContactService {
    ...
    getContactsDetails(id) {
        return this.dataService.get('contact/' + id).catch(error => this.dataService.handleError(error));
    }
    update(contactModel) {
...
let WardComponent = class WardComponent {
    constructor(activeRoute, appSettings, toasterService, lcdaService, wardService) {
        this.activeRoute = activeRoute;
        this.appSettings = appSettings;
        this.toasterService = toasterService;
        this.lcdaService = lcdaService;
    ...
    getLcda(id) {
        this.lcdaService.getLCdaById(id).subscribe(response => {
            const result = Object.assign(new __WEBPACK_IMPORTED_MODULE_7__shared_models_response_model__["a" /* ResponseModel */](), response);
            if (result.code == '00') {
                this.lgda = Object.assign(new __WEBPACK_IMPORTED_MODULE_9__lcda_models_lcda_models__["a" /* LcdaModel */](), result.data);
                this.getWard();
            }
        }, error => {
        });
...
/* harmony export (immutable) */ __webpack_exports__["a"] = WardModel;
...
let WardService = class WardService {
    ...
    all() {
        return this.dataService.get('ward/all').catch(error => this.dataService.handleError(error));
    }
    getWard(pageModel, id) {
        this.dataService.addToHeader('pageSize', pageModel.pageSize.toString());
        this.dataService.addToHeader('pageNum', pageModel.pageNum.toString());
        this.dataService.addToHeader('lcdaId', id);
        return this.dataService.get('ward/paginated').catch(error => this.dataService.handleError(error));
    }
    addWard(wardModel) {
