...
var DemandNoticeSearchComponent = (function () {
    function DemandNoticeSearchComponent(appsettings, toasterService, dnTaxpayer, bankService, dnPaymentService) {
        this.appsettings = appsettings;
        this.toasterService = toasterService;
    ...
    DemandNoticeSearchComponent.prototype.downloadReciept = function (id, billingNumber) {
        ...
        this.dnTaxpayer.downloadReceipt(id).map(function (response) {
...
var DemandNoticeComponent = (function () {
    function DemandNoticeComponent(appsettings, demandnoticeservice, toasterService, wardservice, streetservice, dtsService) {
        this.appsettings = appsettings;
...
var DemandNoticeService = (function () {
    ...
    DemandNoticeService.prototype.get = function (pageModel) {
        ...
        return this.datataservice.get('demandnotice/bylcda').catch(function (error) { return _this.datataservice.handleError(error); });
    };
...
var TaxpayerService = (function () {
    ...
    TaxpayerService.prototype.byLcda = function (lcdaId, pageModel) {
        ...
        this.dataservice.addToHeader('pageNum', pageModel.pageNum.toString());
        this.dataservice.addToHeader('pageSize', pageModel.pageSize.toString());
        return this.dataservice.get('bylcdapaginated/' + lcdaId).catch(function (x) { return _this.dataservice.handleError(x); });
    };
